                                        ...
                                        <tr>
                                           <td>                                            
                                              ...
                                              <div class="banner-email text-center">
                                                <h2><img src={{asset('img/icon_buzon.png')}} /> BUZÓN DE SUGERENCIAS</h2>
                                            </div>
                                          </td>
                                       </tr>
                                       <tr>
                                        <td>
                                         <br>
                                           <div class="div-sub-text">
                                              ...
                                              <p class="text-bold">A la brevedad posible recibirás respuesta por parte del administrador del buzón.</p>
                                              <br>
                                              <p>Saludos</p>
                                              <div class="text-center">
                                              <p>Ir a Portal del Empleado, <span class="text-click">Click aquí</span></p>
                                              </div>
                                           </div>
